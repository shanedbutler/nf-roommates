            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        // OR Line 55 and 58 can be combined into the following line
        ...
        public Room GetById(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    // Note @id allows you to pass in a value to the SQL query command text (here it's passed in as an argument to the parent method)
